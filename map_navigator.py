...
class MapNavigator:
    ...
    def _load_map(self, map_file_path):
        ...
        url = f"https://hackathon2025-dev.fpt.edu.vn/api/maps/get_active_map/?token=a6f202ada430a9fc154b7707188d7278"
        response = requests.get(url, params={"map_type":map_file_path})
        data = response.json()
